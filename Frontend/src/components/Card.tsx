  ...
  return (
    <div className="border border-gray-300 rounded-lg p-4 m-4 flex flex-col justify-between">
      <div className="flex items-center mb-2">
        <div className="flex items-center justify-center rounded-full p-3 mr-3 bg-[#e3f2fd] mr-2">
          <FaDesktop  size="2.5em" color="#64b5f6"/>
        </div>
        <div>
          <h1 className="text-xl">Name of Interview</h1>
      ...
      <button className="bg-[#7c68bb] text-white border-none rounded-lg px-4 py-2 cursor-pointer w-20">
        Start
      </button>
    </div>
  );
